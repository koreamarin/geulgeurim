...
function createDummyData(
  crewId: number, userNickname: string, userProfile: string, thumbnail: string, title: string, upload: Date, views: number, comments: number,
  ...
  return { crewId, userNickname, userProfile, thumbnail, title, date, hit, commentCnt, pen, color, bg, pd, story, conti, status };
}
// prettier-ignore
const dummy = [
  createDummyData(1, '김싸피', 'https://geulgrim.s3.ap-northeast-2.amazonaws.com/profile/notion-avatar-1708927389233.png',
    ...
    new Date('2024-05-03'), 10, 5, 2, 1, 1, 0, 0, 0, 'INPROGRESS'),
