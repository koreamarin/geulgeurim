...
public class ShareCommentController {
    ...
    public ResponseEntity<List<ShareComment>> createShareComment(@RequestBody ShareCommentWriteRequest shareCommentWriteRequest) {

        return new ResponseEntity<>(shareCommentService.writeComment(shareCommentWriteRequest), HttpStatus.CREATED);
    }
